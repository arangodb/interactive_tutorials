...
process_directory "dynamic/Person_studyAt_University" "Person_studyAt_University" "edge" "--from-collection-prefix=Person" "--to-collection-prefix=Organisation" "--datatype UniversityId=string" "--translate PersonId=_from" "--translate UniversityId=_to"
